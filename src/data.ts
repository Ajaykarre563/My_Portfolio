...
export const EXPERIENCE = [
  {
    ...
    description:
      "Worked on real-time deployment of applications using AWS services like EC2, VPC, IAM, and PostgreSQL. Implemented CI/CD pipelines, infrastructure automation using Terraform, and managed Linux servers. Handled troubleshooting and ensured system reliability.",
    technologies: ["AWS", "Terraform", "Jenkins", "Docker", "Linux"],
  },
  {
    year: "2023",
    ...
    technologies: ["Python", "Pandas", "NumPy", "ML", "Data Analysis"],
  },
];
